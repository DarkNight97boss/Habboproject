...
public class WiredConditionFurniHaveFurni extends InteractionWiredCondition {
               ...
               .allMatch(
                  item -> {
                     ...
                     return occupiedTiles.stream()
                        .anyMatch(tile -> room.getItemsAt(tile).stream().anyMatch(matchedItem -> matchedItem != item && matchedItem.getZ() >= minZ));
                  }
               )
            : this.items
               .stream()
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredConditionFurniHaveFurni.JsonData(this.all, this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionFurniHaveFurni.JsonData data = (WiredConditionFurniHaveFurni.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionFurniHaveFurni.JsonData.class);
         this.all = data.all;
