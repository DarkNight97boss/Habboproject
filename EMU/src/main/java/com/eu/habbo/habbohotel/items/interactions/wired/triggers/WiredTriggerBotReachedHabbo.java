...
public class WiredTriggerBotReachedHabbo extends InteractionWiredTrigger {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerBotReachedHabbo.JsonData(this.botName));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerBotReachedHabbo.JsonData data = (WiredTriggerBotReachedHabbo.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerBotReachedHabbo.JsonData.class);
