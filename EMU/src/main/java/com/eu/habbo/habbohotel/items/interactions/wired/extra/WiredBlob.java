...
public class WiredBlob extends InteractionDefault {
   ...
   public void onPlace(Room room) {
      super.onPlace(room);
      this.setExtradata(WiredBlob.WiredBlobState.USED.getState());
   ...
   public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
      ...
      if (this.getExtradata().equals(WiredBlob.WiredBlobState.ACTIVE.getState())) {
   ...
   public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
      if (!this.RESETS_WITH_GAME
         ...
         && room.getGames().stream().anyMatch(game -> game.getState().equals(GameState.RUNNING) || game.getState().equals(GameState.PAUSED))) {
         this.setExtradata(
            this.getExtradata().equals(WiredBlob.WiredBlobState.ACTIVE.getState())
               ? WiredBlob.WiredBlobState.USED.getState()
               : WiredBlob.WiredBlobState.ACTIVE.getState()
         );
         room.updateItem(this);
      }
   }
   ...
   public void onGameStart(Room room) {
      if (this.RESETS_WITH_GAME) {
         this.setExtradata(WiredBlob.WiredBlobState.ACTIVE.getState());
         room.updateItem(this);
      }
   }
