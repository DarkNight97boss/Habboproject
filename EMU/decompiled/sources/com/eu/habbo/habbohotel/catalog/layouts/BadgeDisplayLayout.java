...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/BadgeDisplayLayout.class */
public class BadgeDisplayLayout extends CatalogPage {
    public BadgeDisplayLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("badge_display");
