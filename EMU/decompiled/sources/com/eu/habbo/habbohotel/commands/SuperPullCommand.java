...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/commands/SuperPullCommand.class */
public class SuperPullCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] strArr) throws Exception {
        ...
        if (tileInFront == gameClient.getHabbo().getHabboInfo().getCurrentRoom().getLayout().getDoorTile()) {
            gameClient.getHabbo().whisper(Emulator.getTexts().getValue("commands.error.cmd_pull.invalid").replace("%username%", strArr[1]), RoomChatMessageBubbles.ALERT);
            return true;
        }
