...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/games/freeze/InteractionFreezeExitTile.class */
public class InteractionFreezeExitTile extends HabboItem {
    public InteractionFreezeExitTile(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        setExtradata("0");
    }

    public InteractionFreezeExitTile(int i, int i2, Item item, String str, int i3, int i4) {
