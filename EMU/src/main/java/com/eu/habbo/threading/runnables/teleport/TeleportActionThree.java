   ...
   public void run() {
      if (this.client.getHabbo().getHabboInfo().getCurrentRoom() == this.room) {
         ...
         if (targetRoom == null) {
            ...
            HabboItem targetTeleport = targetRoom.getHabboItem(((InteractionTeleport)this.currentTeleport).getTargetId());
            if (targetTeleport == null) {
               ...
               if (teleportLocation == null) {
                  ...
                  Emulator.getThreading()
                     .run(new TeleportActionFour(targetTeleport, targetRoom, this.client), this.currentTeleport instanceof InteractionTeleportTile ? 0L : 500L);
               }
            }
         }
      }
