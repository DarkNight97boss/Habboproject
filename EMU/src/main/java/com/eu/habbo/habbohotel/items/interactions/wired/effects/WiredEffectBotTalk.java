...
public class WiredEffectBotTalk extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotTalk.JsonData(this.botName, this.mode, this.message, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotTalk.JsonData data = (WiredEffectBotTalk.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotTalk.JsonData.class);
