...
public class Voucher {
   ...
   private void loadHistory() {
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("SELECT * FROM voucher_history WHERE voucher_id = ?");
   ...
   public void addHistoryEntry(int userId) {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO voucher_history (`voucher_id`, `user_id`, `timestamp`) VALUES (?, ?, ?)");
