...
public class WiredConditionNotFurniTypeMatch extends InteractionWiredCondition {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      if (this.items.isEmpty()) {
         return true;
      } else if (stuff != null && stuff.length >= 1 && stuff[0] instanceof HabboItem) {
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredConditionNotFurniTypeMatch.JsonData(this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionFurniTypeMatch.JsonData data = (WiredConditionFurniTypeMatch.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionFurniTypeMatch.JsonData.class);
