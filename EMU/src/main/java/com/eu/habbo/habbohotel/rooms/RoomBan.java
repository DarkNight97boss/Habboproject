...
public class RoomBan {
   ...
   public void insert() {
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO room_bans (room_id, user_id, ends) VALUES (?, ?, ?)");
   ...
   public void delete() {
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("DELETE FROM room_bans WHERE room_id = ? AND user_id = ?");
