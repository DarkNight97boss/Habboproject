...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/BuildersClubLoyaltyLayout.class */
public class BuildersClubLoyaltyLayout extends CatalogPage {
    public BuildersClubLoyaltyLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("builders_club_loyalty");
