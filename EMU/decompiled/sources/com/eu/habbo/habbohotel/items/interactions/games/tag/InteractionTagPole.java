...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/games/tag/InteractionTagPole.class */
public class InteractionTagPole extends HabboItem {
    public InteractionTagPole(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public InteractionTagPole(int i, int i2, Item item, String str, int i3, int i4) {
