...
public class WiredConditionNotHabboHasEffect extends InteractionWiredCondition {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionNotHabboHasEffect.JsonData(this.effectId));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionNotHabboHasEffect.JsonData data = (WiredConditionNotHabboHasEffect.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionNotHabboHasEffect.JsonData.class);
