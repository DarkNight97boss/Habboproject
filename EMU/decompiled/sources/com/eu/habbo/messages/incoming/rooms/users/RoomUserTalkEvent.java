...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/incoming/rooms/users/RoomUserTalkEvent.class */
public class RoomUserTalkEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (currentRoom != null && this.client.getHabbo().getHabboStats().allowTalk()) {
            ...
            if (roomChatMessage.getMessage().length() > RoomChatMessage.MAXIMUM_LENGTH) {
                ...
                if (((UserTalkEvent) Emulator.getPluginManager().fireEvent(new UserTalkEvent(this.client.getHabbo(), roomChatMessage, RoomChatType.TALK))).isCancelled()) {
                    return;
                }
                currentRoom.talk(this.client.getHabbo(), roomChatMessage, RoomChatType.TALK);
