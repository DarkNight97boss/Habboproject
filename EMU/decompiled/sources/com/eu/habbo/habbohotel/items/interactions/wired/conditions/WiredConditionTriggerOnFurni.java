...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionTriggerOnFurni.class */
public class WiredConditionTriggerOnFurni extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionTriggerOnFurni$JsonData.class */
    ...
    public WiredConditionTriggerOnFurni(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.items = new THashSet<>();
    }

    public WiredConditionTriggerOnFurni(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    protected boolean triggerOnFurni(RoomUnit roomUnit, Room room) {
        THashSet<HabboItem> itemsAt = room.getItemsAt(roomUnit.getCurrentLocation());
        Stream stream = this.items.stream();
        Objects.requireNonNull(itemsAt);
    ...
    protected void refresh() {
        ...
        if (room == null) {
            ...
            while (it.hasNext()) {
                ...
                if (habboItem.getRoomId() != room.getId()) {
