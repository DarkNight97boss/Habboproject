...
public class WiredTriggerHabboEntersRoom extends InteractionWiredTrigger {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      if (habbo != null) {
         return this.username.length() > 0 ? habbo.getHabboInfo().getUsername().equalsIgnoreCase(this.username) : true;
      } else {
         return false;
      }
   }
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerHabboEntersRoom.JsonData(this.username));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerHabboEntersRoom.JsonData data = (WiredTriggerHabboEntersRoom.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerHabboEntersRoom.JsonData.class);
