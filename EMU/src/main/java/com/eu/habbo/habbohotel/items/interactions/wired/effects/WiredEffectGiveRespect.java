...
public class WiredEffectGiveRespect extends InteractionWiredEffect {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      var10000.respectPointsReceived = var10000.respectPointsReceived + this.respects;
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectGiveRespect.JsonData(this.respects, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectGiveRespect.JsonData data = (WiredEffectGiveRespect.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectGiveRespect.JsonData.class);
