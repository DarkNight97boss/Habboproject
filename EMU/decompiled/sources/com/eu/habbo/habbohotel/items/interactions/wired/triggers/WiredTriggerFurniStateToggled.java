...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerFurniStateToggled.class */
public class WiredTriggerFurniStateToggled extends InteractionWiredTrigger {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerFurniStateToggled$JsonData.class */
    ...
    public WiredTriggerFurniStateToggled(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.items = new THashSet<>();
    }

    public WiredTriggerFurniStateToggled(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] objArr) {
        if (objArr.length < 1 || room.getHabbo(roomUnit) == null) {
            return false;
        }
        for (Object obj : objArr) {
            if (obj instanceof WiredEffectType) {
                return false;
            }
        }
        if (objArr[0] instanceof HabboItem) {
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        while (it.hasNext()) {
            ...
            if (habboItem.getRoomId() != getRoomId()) {
                tHashSet.add(habboItem);
            } else if (room.getHabboItem(habboItem.getId()) == null) {
                tHashSet.add(habboItem);
            }
        }
