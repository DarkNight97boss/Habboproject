...
public class WiredEffectBotClothes extends InteractionWiredEffect {
   ...
   public void serializeWiredData(ServerMessage message, Room room) {
      ...
      message.appendString(this.botName + '\t' + "" + this.botLook);
      message.appendInt(0);
      message.appendInt(0);
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotClothes.JsonData(this.botName, this.botLook, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotClothes.JsonData data = (WiredEffectBotClothes.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotClothes.JsonData.class);
