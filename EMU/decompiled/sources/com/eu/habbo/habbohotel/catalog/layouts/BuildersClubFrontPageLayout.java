...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/BuildersClubFrontPageLayout.class */
public class BuildersClubFrontPageLayout extends CatalogPage {
    public BuildersClubFrontPageLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("builders_club_frontpage");
