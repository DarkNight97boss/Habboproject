...
public class WiredConditionNotHabboWearsBadge extends InteractionWiredCondition {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionNotHabboWearsBadge.JsonData(this.badge));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionNotHabboWearsBadge.JsonData data = (WiredConditionNotHabboWearsBadge.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionNotHabboWearsBadge.JsonData.class);
