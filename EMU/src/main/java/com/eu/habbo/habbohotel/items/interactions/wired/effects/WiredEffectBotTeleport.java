...
public class WiredEffectBotTeleport extends InteractionWiredEffect {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      int j = 1;
      TObjectHashIterator var8 = this.items.iterator();
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotTeleport.JsonData(this.botName, itemIds, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotTeleport.JsonData data = (WiredEffectBotTeleport.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotTeleport.JsonData.class);
