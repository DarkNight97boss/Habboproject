...
public class WiredConditionHabboHasHandItem extends InteractionWiredCondition {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      return roomUnit == null ? false : roomUnit.getHandItem() == this.handItem;
   }

   @Override
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionHabboHasHandItem.JsonData(this.handItem));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      try {
         ...
         if (wiredData.startsWith("{")) {
            WiredConditionHabboHasHandItem.JsonData data = (WiredConditionHabboHasHandItem.JsonData)WiredHandler.getGsonBuilder()
               .create()
               .fromJson(wiredData, WiredConditionHabboHasHandItem.JsonData.class);
