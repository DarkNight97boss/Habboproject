...
export const FurniEditorView: FC<{}> = () =>
{
    ...
    // Was `acc_catalogfurni` (Nitro V3 fork-only permission) — the EMU handler
    // gates on ACC_SUPPORTTOOL which is what we have available in stock Arcturus
    // and what the toolbar icon uses. Keep them aligned so the panel actually
    // opens when staff click the toolbar icon.
