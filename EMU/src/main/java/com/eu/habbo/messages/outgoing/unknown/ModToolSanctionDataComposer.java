...
public class ModToolSanctionDataComposer extends MessageComposer {
   ...
   private final ModToolSanctionDataComposer.CFHSanction sanction;

   public ModToolSanctionDataComposer(int unknownInt1, int accountId, ModToolSanctionDataComposer.CFHSanction sanction) {
