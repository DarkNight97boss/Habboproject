...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionWiredExtra.class */
public abstract class InteractionWiredExtra extends InteractionWired {
    protected InteractionWiredExtra(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    protected InteractionWiredExtra(int i, int i2, Item item, String str, int i3, int i4) {
