...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionFurniHaveHabbo.class */
public class WiredConditionFurniHaveHabbo extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionFurniHaveHabbo$JsonData.class */
    ...
    public WiredConditionFurniHaveHabbo(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.items = new THashSet<>();
    }

    public WiredConditionFurniHaveHabbo(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] objArr) {
        ...
        return this.items.stream().allMatch(habboItem -> {
