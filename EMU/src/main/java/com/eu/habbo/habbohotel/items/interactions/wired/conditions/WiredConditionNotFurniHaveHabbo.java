...
public class WiredConditionNotFurniHaveHabbo extends InteractionWiredCondition {
         ...
         .noneMatch(
            item -> {
               THashSet<RoomTile> occupiedTiles = room.getLayout()
                  .getTilesAt(
                     room.getLayout().getTile(item.getX(), item.getY()), item.getBaseItem().getWidth(), item.getBaseItem().getLength(), item.getRotation()
                  );
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredConditionNotFurniHaveHabbo.JsonData(this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionFurniHaveHabbo.JsonData data = (WiredConditionFurniHaveHabbo.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionFurniHaveHabbo.JsonData.class);
