...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerRepeater.class */
public class WiredTriggerRepeater extends InteractionWiredTrigger implements ICycleable, WiredTriggerReset {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerRepeater$JsonData.class */
    ...
    public WiredTriggerRepeater(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.repeatTime = 5000;
        this.counter = 0;
    }

    public WiredTriggerRepeater(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        serverMessage.appendInt(Integer.valueOf(this.repeatTime / 500));
        serverMessage.appendInt((Integer) 0);
        ...
        room.getRoomSpecialTypes().getEffects(getX(), getY()).forEach(new TObjectProcedure<InteractionWiredEffect>() { // from class: com.eu.habbo.habbohotel.items.interactions.wired.triggers.WiredTriggerRepeater.1
    ...
    public boolean saveData(WiredSettings wiredSettings) {
        ...
        this.repeatTime = wiredSettings.getIntParams()[0] * 500;
        this.counter = 0;
        if (this.repeatTime >= 500) {
            return true;
        }
