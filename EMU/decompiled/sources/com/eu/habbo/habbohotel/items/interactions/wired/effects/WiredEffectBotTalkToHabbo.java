...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectBotTalkToHabbo.class */
public class WiredEffectBotTalkToHabbo extends InteractionWiredEffect {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectBotTalkToHabbo$JsonData.class */
    ...
    public WiredEffectBotTalkToHabbo(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.botName = Emulator.PREVIEW;
        this.message = Emulator.PREVIEW;
    }

    public WiredEffectBotTalkToHabbo(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        room.getRoomSpecialTypes().getTriggers(getX(), getY()).forEach(new TObjectProcedure<InteractionWiredTrigger>() { // from class: com.eu.habbo.habbohotel.items.interactions.wired.effects.WiredEffectBotTalkToHabbo.1
    ...
    public boolean saveData(WiredSettings wiredSettings, GameClient gameClient) throws WiredSaveException {
        if (wiredSettings.getIntParams().length < 1) {
            throw new WiredSaveException("Missing mode");
        }
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] objArr) {
        ...
        if (this.mode == 1) {
            bot.whisper(strReplace, habbo);
            return true;
        }
        bot.talk(habbo.getHabboInfo().getUsername() + ": " + strReplace);
        return true;
    }
