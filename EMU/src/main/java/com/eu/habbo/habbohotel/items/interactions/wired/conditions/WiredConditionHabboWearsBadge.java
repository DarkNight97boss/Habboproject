...
public class WiredConditionHabboWearsBadge extends InteractionWiredCondition {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionHabboWearsBadge.JsonData(this.badge));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionHabboWearsBadge.JsonData data = (WiredConditionHabboWearsBadge.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionHabboWearsBadge.JsonData.class);
