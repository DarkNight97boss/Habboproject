...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotInTeam.class */
public class WiredConditionNotInTeam extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotInTeam$JsonData.class */
    ...
    public WiredConditionNotInTeam(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.teamColor = GameTeamColors.RED;
    }

    public WiredConditionNotInTeam(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] objArr) {
        ...
        return habbo == null || habbo.getHabboInfo().getGamePlayer() == null || !habbo.getHabboInfo().getGamePlayer().getTeamColor().equals(this.teamColor);
    }
