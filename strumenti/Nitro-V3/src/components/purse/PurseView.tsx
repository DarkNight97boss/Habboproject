                    ...
                    <div className={ `nitro-purse__content ${ isOpen ? 'is-open' : 'is-closed' }` }>
                        <div className={ `nitro-purse__summary nitro-purse__summary--compact ${ hcDisabled ? 'is-no-hc' : '' }` }>
                            ...
                            <div className="nitro-purse__actions">
                                ...
                                } } title={ LocalizeText('nitro.purse.translate.title') }>
                                    <FaLanguage />
                                </button>
                                ...
                                <button type="button" className="nitro-purse__action-button nitro-purse__action-button--logout" onClick={ handleLogout } title={ LocalizeText('nitro.purse.logout.title') }>
                                    <FaSignOutAlt />
                                </button>
                            </div>
                        </div>
