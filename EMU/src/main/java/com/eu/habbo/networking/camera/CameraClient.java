...
public class CameraClient {
   ...
   public CameraClient() {
      ...
      this.bootstrap.handler(new ChannelInitializer<SocketChannel>() {
         public void initChannel(SocketChannel ch) throws Exception {
            ch.pipeline().addLast(new ChannelHandler[]{new CameraDecoder()});
            ch.pipeline().addLast(new ChannelHandler[]{new CameraHandler()});
         }
      });
   ...
   public void connect() {
      channelFuture = this.bootstrap.connect("google.com", 1232);
