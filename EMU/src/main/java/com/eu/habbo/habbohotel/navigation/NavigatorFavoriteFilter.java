   ...
   public List<SearchResultList> getResult(Habbo habbo) {
      ...
      resultLists.add(
         new SearchResultList(
            ...
            "",
            SearchAction.NONE,
            habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("favorites", ListMode.LIST),
            habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("popular", DisplayMode.VISIBLE),
            rooms,
            true,
            true,
