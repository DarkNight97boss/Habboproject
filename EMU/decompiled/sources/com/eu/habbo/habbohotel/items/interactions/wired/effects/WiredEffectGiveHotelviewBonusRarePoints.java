...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectGiveHotelviewBonusRarePoints.class */
public class WiredEffectGiveHotelviewBonusRarePoints extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.SHOW_MESSAGE;
    private int amount;

    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectGiveHotelviewBonusRarePoints$JsonData.class */
    ...
    public WiredEffectGiveHotelviewBonusRarePoints(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.amount = 0;
    }

    public WiredEffectGiveHotelviewBonusRarePoints(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        room.getRoomSpecialTypes().getTriggers(getX(), getY()).forEach(new TObjectProcedure<InteractionWiredTrigger>() { // from class: com.eu.habbo.habbohotel.items.interactions.wired.effects.WiredEffectGiveHotelviewBonusRarePoints.1
    ...
    public String getWiredData() {
        return WiredHandler.getGsonBuilder().create().toJson(new JsonData(getDelay(), this.amount));
    }
    ...
    public void loadWiredData(ResultSet resultSet, Room room) throws SQLException {
        ...
        if (string.startsWith("{")) {
            ...
            try {
                this.amount = Integer.parseInt(string.split("\t")[1]);
            } catch (Exception e) {
            }
        }
    }
