...
public class WiredTriggerHabboSaysKeyword extends InteractionWiredTrigger {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      if (this.key.length() > 0 && stuff[0] instanceof String && ((String)stuff[0]).toLowerCase().contains(this.key.toLowerCase())) {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerHabboSaysKeyword.JsonData(this.ownerOnly, this.key));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerHabboSaysKeyword.JsonData data = (WiredTriggerHabboSaysKeyword.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerHabboSaysKeyword.JsonData.class);
