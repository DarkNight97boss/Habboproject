...
public class WiredEffectBotTalkToHabbo extends InteractionWiredEffect {
   ...
   public void serializeWiredData(ServerMessage message, Room room) {
      ...
      message.appendString(this.botName + "" + '\t' + "" + this.message);
      message.appendInt(1);
      ...
      if (habbo != null) {
         ...
         m = m.replace(Emulator.getTexts().getValue("wired.variable.username", "%username%"), habbo.getHabboInfo().getUsername())
            ...
            .replace(
               ...
               habbo.getHabboInfo().getCurrencyAmount(Emulator.getConfig().getInt("seasonal.primary.type")) + ""
            )
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotTalkToHabbo.JsonData(this.botName, this.mode, this.message, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotTalkToHabbo.JsonData data = (WiredEffectBotTalkToHabbo.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotTalkToHabbo.JsonData.class);
