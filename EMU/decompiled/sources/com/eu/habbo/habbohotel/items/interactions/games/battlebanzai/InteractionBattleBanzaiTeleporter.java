...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/games/battlebanzai/InteractionBattleBanzaiTeleporter.class */
public class InteractionBattleBanzaiTeleporter extends HabboItem {
    public InteractionBattleBanzaiTeleporter(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        setExtradata("0");
    }

    public InteractionBattleBanzaiTeleporter(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objArr) throws Exception {
        InteractionBattleBanzaiTeleporter randomTeleporter;
        super.onWalkOn(roomUnit, room, objArr);
        if (objArr.length >= 3 || (randomTeleporter = room.getRoomSpecialTypes().getRandomTeleporter(null, this)) == null) {
            return;
        }
        setExtradata("1");
        ...
        Emulator.getThreading().run(new BanzaiRandomTeleport(this, randomTeleporter, roomUnit, room), 500L);
    }
