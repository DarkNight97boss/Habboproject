...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotInGroup.class */
public class WiredConditionNotInGroup extends InteractionWiredCondition {
    ...
    public WiredConditionNotInGroup(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public WiredConditionNotInGroup(int i, int i2, Item item, String str, int i3, int i4) {
