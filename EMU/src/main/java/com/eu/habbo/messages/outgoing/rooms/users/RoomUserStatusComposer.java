...
public class RoomUserStatusComposer extends MessageComposer {
   ...
   protected ServerMessage composeInternal() {
      ...
      if (this.roomUnits != null) {
         ...
         TObjectHashIterator var1 = this.roomUnits.iterator();

         while (var1.hasNext()) {
            RoomUnit roomUnit = (RoomUnit)var1.next();
            ...
            for (Entry<RoomUnitStatus, String> entry : roomUnit.getStatusMap().entrySet()) {
         ...
         synchronized (this.habbos) {
            ...
            for (Habbo habbo : this.habbos) {
               ...
               for (Entry<RoomUnitStatus, String> entry : habbo.getRoomUnit().getStatusMap().entrySet()) {
                  status.append(entry.getKey()).append(" ").append(entry.getValue()).append("/");
               }
