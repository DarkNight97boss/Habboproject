...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionMoreTimeElapsed.class */
public class WiredConditionMoreTimeElapsed extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionMoreTimeElapsed$JsonData.class */
    ...
    public WiredConditionMoreTimeElapsed(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public WiredConditionMoreTimeElapsed(int i, int i2, Item item, String str, int i3, int i4) {
