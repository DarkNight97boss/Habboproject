...
public class CatalogFeaturedPage implements ISerialize {
   ...
   private final CatalogFeaturedPage.Type type;
   private final int expireTimestamp;
   private final String pageName;
   private final int pageId;
   private final String productName;

   public CatalogFeaturedPage(
      int slotId, String caption, String image, CatalogFeaturedPage.Type type, int expireTimestamp, String pageName, int pageId, String productName
   ) {
      this.slotId = slotId;
