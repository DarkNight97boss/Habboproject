    ...
    return (
        <div className="flex flex-col gap-2 h-full overflow-auto p-1">
            ...
            <div className="relative flex items-center justify-center p-4 rounded-lg min-h-[56px]"
                ...
                <span className="relative ml-2 text-white/80 text-lg font-medium">{ LocalizeText('catalog.prefix.username') }</span>
            </div>
                    ...
                    <div className="flex gap-1">
                        <button
                            ...
                            { selectedIcon
                                ...
                                : <span className="opacity-40 text-xs">{ LocalizeText('catalog.prefix.emoji') } ▼</span>
                            }
                        </button>
                        { selectedIcon &&
                            <button
