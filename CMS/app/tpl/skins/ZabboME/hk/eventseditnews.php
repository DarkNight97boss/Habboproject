	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li>Moderation</li> <li class="active">Edit Event Article</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Edit Event Article</h1>
			</div>
		</div><!--/.row-->
...
echo '
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Success!</strong> Event News Article updated. Redirecting you back to the dashboard...
									</div>';
header("refresh:3;url=index.php?url=eventsnews");
}
}
?>
...
?>
									...
									<p></p>
									<div class="control-group">
										<button type="submit" class="btn btn-primary btn-sm" style="float: right;background: #217332;margin-top: 2px;margin-left: 5px;height: 40px;font-variant-caps: all-small-caps;font-size: 15px;font-family: sans-serif;font-weight: bolder;border-radius: 3px;border-color: #0cde39;" name="submit">Edit Event Article</button>
									</div>
								</form>
					</div>
				</div>
