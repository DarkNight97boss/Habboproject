                        ...
                        <div className="news-footer">
                            ...
                            { hasMany &&
                                <div className="news-pager">
                                    <button type="button" className="arrow-btn" aria-label={ t('nitro.login.news.previous', 'Notizia precedente') } onClick={ prev }>&lsaquo;</button>
                                    <span className="news-counter">{ index + 1 }/{ items.length }</span>
                                    <button type="button" className="arrow-btn" aria-label={ t('nitro.login.news.next', 'Notizia successiva') } onClick={ next }>&rsaquo;</button>
                                </div>
                            }
                        </div>
                    </div>
