...
public class WiredTriggerRepeaterLong extends InteractionWiredTrigger implements ICycleable, WiredTriggerReset {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerRepeaterLong.JsonData(this.repeatTime));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerRepeaterLong.JsonData data = (WiredTriggerRepeaterLong.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerRepeaterLong.JsonData.class);
