...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/commands/RoomPixelsCommand.class */
public class RoomPixelsCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] strArr) throws Exception {
        ...
        try {
            ...
            String strReplace = Emulator.getTexts().getValue("commands.generic.cmd_duckets.received").replace("%amount%", iIntValue + Emulator.PREVIEW);
            for (Habbo habbo : gameClient.getHabbo().getHabboInfo().getCurrentRoom().getHabbos()) {
                habbo.givePixels(iIntValue);
