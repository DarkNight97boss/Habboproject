...
public class InteractionOneWayGate extends HabboItem {
   ...
   public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
      ...
      if (client != null) {
         ...
         if (tileInfront.x == unit.getX() && tileInfront.y == unit.getY() && !currentLocation.hasUnits()) {
            ...
            onSuccess.add(() -> {
               ...
               Emulator.getThreading().run(() -> WiredHandler.handle(WiredTriggerType.WALKS_ON_FURNI, unit, room, new Object[]{this}), 500L);
            });
            onFail.add(() -> {
