...
public class WiredTriggerScoreAchieved extends InteractionWiredTrigger {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerScoreAchieved.JsonData(this.score));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerScoreAchieved.JsonData data = (WiredTriggerScoreAchieved.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerScoreAchieved.JsonData.class);
