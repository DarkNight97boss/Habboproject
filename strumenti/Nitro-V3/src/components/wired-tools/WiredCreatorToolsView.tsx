    ...
    return (
        <>
                        ...
                        <div className="p-4 min-h-[360px] flex items-center justify-center text-center text-[#555]">
                            <div className="max-w-[320px]">
                                ...
                                <div className="mt-2 text-[12px]">
                                    { LocalizeText('wired.tools.tab.placeholder') }
                                </div>
                            </div>
                        </div> }
            ...
            <NitroCardView className="min-w-[760px] max-w-[760px] max-h-[520px]" theme="primary-slim" uniqueKey="wired-monitor-history" windowPosition={ DraggableWindowPosition.TOP_LEFT } offsetLeft={ 560 } offsetTop={ 40 }>
                <NitroCardHeaderView headerText={ LocalizeText('wired.tools.monitor.logs.title') } onCloseClick={ () => setIsMonitorHistoryOpen(false) } />
                <NitroCardContentView className="text-black bg-[#f4efe3] p-3 flex flex-col gap-3" overflow="hidden">
                    <div className="flex flex-wrap items-center gap-2 text-[12px]">
                        <span className="text-[#555]">{ LocalizeText('wired.tools.monitor.column.severity') }:</span>
                        ...
                        <span className="ml-2 text-[#555]">{ LocalizeText('wired.tools.monitor.column.type') }:</span>
                        <select
                    ...
                    <div className="grow overflow-y-auto border border-[#d1ccbf] rounded bg-white">
                        <table className="w-full text-[12px]">
                            <thead className="bg-[#efede5] sticky top-0">
                                <tr>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.type') }</th>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.severity') }</th>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.trigger') }</th>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.motivation') }</th>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.occurred_at') }</th>
                                </tr>
                            </thead>
                            <tbody>
                                { !filteredMonitorHistoryRows.length &&
                                    <tr>
                                        <td className="px-2 py-3 text-center text-[#8b8678]" colSpan={ 5 }>{ LocalizeText('wired.tools.monitor.logs.empty') }</td>
                                    </tr> }
            ...
            <NitroCardView className="min-w-[560px] max-w-[560px] max-h-[520px]" theme="primary-slim" uniqueKey="wired-monitor-info" windowPosition={ DraggableWindowPosition.TOP_LEFT } offsetLeft={ 610 } offsetTop={ 80 }>
                <NitroCardHeaderView headerText={ LocalizeText('wired.tools.monitor.info.title') } onCloseClick={ () => setIsMonitorInfoOpen(false) } />
            ...
            <NitroCardView className="min-w-[860px] max-w-[860px] max-h-[620px]" theme="primary-slim" uniqueKey="wired-variable-management" windowPosition={ DraggableWindowPosition.TOP_LEFT } offsetLeft={ 540 } offsetTop={ 60 }>
                <NitroCardHeaderView headerText={ LocalizeText('wired.tools.variable_management.title') } onCloseClick={ () => setIsVariableManageOpen(false) } />
                <NitroCardContentView className="text-black bg-[#f4efe3] p-3 flex flex-col gap-3" overflow="hidden">
                    <div className="rounded border border-[#c8c2b2] bg-white p-3 flex items-center justify-between gap-3">
                        <div className="grow flex flex-col items-center text-center">
                            ...
                            <Text><b>{ LocalizeText('wired.tools.variable.name') }:</b> { selectedVariableDefinition.key }</Text>
                        </div>
                        <Button variant="secondary" onClick={ () => requestUserVariables() }>{ LocalizeText('wired.tools.action.refresh') }</Button>
                    </div>
                    <div className="flex flex-wrap items-center gap-4 text-[12px]">
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                { variableManageTypeOptions.map(type => (
                                    <option key={ type } value={ type }>
                                        { (type === 'ALL')
                                            ? ((variablesType === 'global') ? LocalizeText('wired.tools.variable_management.all_entries') : LocalizeText('wired.tools.variable_management.all_types'))
                                            : type }
                                    </option>
                                )) }
                            </select>
                        ...
                        <div className="flex items-center gap-2">
                            <Text>{ LocalizeText('wired.tools.variable_management.sort_by') }:</Text>
                            <select
                                className="rounded border border-[#b8b2a4] bg-white px-2 py-[2px] text-[12px]"
                        ...
                        <table className="w-full text-[12px]">
                            <thead className="bg-[#efede5] sticky top-0">
                                <tr>
                                    ...
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.variable_management.column.name') }</th>
                                    { !!selectedVariableDefinition.hasCreationTime && <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.variable_management.column.creation_time') }</th> }
                                    { !!selectedVariableDefinition.hasUpdateTime && <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.variable_management.column.update_time') }</th> }
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.column.value') }</th>
                                    <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.variable_management.column.manage') }</th>
                                </tr>
                            </thead>
                            <tbody>
                                { !pagedVariableManageEntries.length &&
                                    <tr>
                                        <td className="px-2 py-3 text-center text-[#8b8678]" colSpan={ (selectedVariableDefinition.hasCreationTime ? 6 : 5) }>{ LocalizeText('wired.tools.variable_management.no_entries') }</td>
                                    </tr> }
                    ...
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2 text-[12px] text-[#555]">
                            <span>{ LocalizeText('wired.tools.variable_management.pagination.label', [ 'count' ], [ filteredVariableManageEntries.length.toString() ]) }</span>
                            <input
                            ...
                            <span>{ LocalizeText('wired.tools.variable_management.pagination.of', [ 'total' ], [ variableManagePageCount.toString() ]) }</span>
                        </div>
                        <div className="flex gap-2">
                            <button
                                className="min-w-[36px] rounded border border-[#b8b2a4] bg-white px-2 py-1 text-[12px] disabled:opacity-40"
            ...
            <NitroCardView className="min-w-[430px] max-w-[430px] max-h-[620px]" theme="primary-slim" uniqueKey="wired-variable-management-entry" windowPosition={ DraggableWindowPosition.TOP_LEFT } offsetLeft={ 890 } offsetTop={ 110 }>
                ...
                <NitroCardContentView className="text-black bg-[#f4efe3] p-3 flex flex-col gap-3 relative" overflow="hidden">
                    ...
                    <div className="flex flex-col gap-2">
                        <Text bold>{ LocalizeText('wired.tools.holder_info') }:</Text>
                    ...
                    <div className="flex flex-col gap-2 min-h-0 grow">
                        <Text bold>{ (variablesType === 'global') ? `${ LocalizeText('wired.tools.holder.room_variables') }:` : `${ LocalizeText('wired.tools.holder.assigned_variables') }:` }</Text>
                        <div className="grow rounded border border-[#d1ccbf] bg-white overflow-y-auto">
                            <table className="w-full text-[12px]">
                                <thead className="bg-[#efede5] sticky top-0">
                                    <tr>
                                        <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.column.variable') }</th>
                                        <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.column.value') }</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    { !managedHolderVariableEntries.length &&
                                        <tr>
                                            <td className="px-2 py-3 text-center text-[#8b8678]" colSpan={ 2 }>{ LocalizeText('wired.tools.holder.no_variables') }</td>
                                        </tr> }
                    ...
                    <div className="relative flex items-center justify-between gap-3 pt-1">
                        { isManagedGiveOpen &&
                            <div className="absolute right-0 bottom-full mb-2 w-[210px] rounded border border-[#8d887a] bg-[#efede5] p-3 shadow-[0_2px_8px_rgba(0,0,0,.25)] z-10 flex flex-col gap-2">
                                <Text bold>{ LocalizeText('wired.tools.column.variable') }:</Text>
                                <select
                                    ...
                                    { !availableManagedHolderDefinitions.length && <option value={ 0 }>{ LocalizeText('wired.tools.variables.none_available') }</option> }
                                ...
                                <Text bold>{ LocalizeText('wired.tools.column.value') }:</Text>
                                <input
                                ...
                                <Button disabled={ !canGiveManagedHolderVariable } variant="secondary" onClick={ () => giveManagedHolderVariable() }>{ LocalizeText('wired.tools.action.create') }</Button>
                            </div> }
                        <Button disabled={ !canRemoveManagedHolderVariable } variant="secondary" onClick={ () => removeManagedHolderVariable() }>{ LocalizeText('wired.tools.action.remove_variable') }</Button>
                        <Button
                            disabled={ !canGiveManagedHolderVariable }
                            variant="secondary"
                            onClick={ () => setIsManagedGiveOpen(value => !value) }>
                            { LocalizeText('wired.tools.action.give_variable') }
                        </Button>
                    </div>
                </NitroCardContentView>
            </NitroCardView> }
            ...
            <NitroCardView className="min-w-[470px] max-w-[470px] max-h-[500px]" theme="primary-slim" uniqueKey="wired-monitor-error-info" windowPosition={ DraggableWindowPosition.TOP_LEFT } offsetLeft={ 660 } offsetTop={ 120 }>
                <NitroCardHeaderView
                    headerText={ LocalizeText('wired.tools.monitor.error_info.title') }
                    onCloseClick={ () =>
                    {
                        setSelectedMonitorErrorType(null);
                        setSelectedMonitorLogDetails(null);
                ...
                <NitroCardContentView className="text-black bg-[#f4efe3] p-4 flex flex-col gap-3 overflow-y-auto">
                    ...
                    { !!selectedMonitorLogDetails &&
                        <div className="rounded border border-[#d8d2c3] bg-white/60 p-3 flex flex-col gap-1">
                            <Text><b>{ LocalizeText('wired.tools.monitor.column.trigger') }:</b> { selectedMonitorDetailSource }</Text>
                            <Text><b>{ LocalizeText('wired.tools.monitor.column.motivation') }:</b> { selectedMonitorLogDetails.reason }</Text>
                            { !!selectedMonitorLogDetails.amount && <Text><b>{ LocalizeText('wired.tools.monitor.column.amount') }:</b> { selectedMonitorLogDetails.amount }</Text> }
                            { !!selectedMonitorLogDetails.latest && <Text><b>{ LocalizeText('wired.tools.monitor.column.latest_occurrence') }:</b> { selectedMonitorLogDetails.latest }</Text> }
                            { !!selectedMonitorLogDetails.occurredAt && <Text><b>{ LocalizeText('wired.tools.monitor.column.occurred_at') }:</b> { selectedMonitorLogDetails.occurredAt }</Text> }
                        </div> }
