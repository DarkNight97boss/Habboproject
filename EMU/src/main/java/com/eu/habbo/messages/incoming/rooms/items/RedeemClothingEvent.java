...
public class RedeemClothingEvent extends MessageHandler {
   ...
   public void handle() throws Exception {
      ...
      if (this.client.getHabbo().getHabboInfo().getCurrentRoom() != null
         ...
         if (item != null && item.getUserId() == this.client.getHabbo().getHabboInfo().getId() && item instanceof InteractionClothing) {
            ...
            if (clothing != null) {
               if (!this.client.getHabbo().getInventory().getWardrobeComponent().getClothing().contains(clothing.id)) {
                  ...
                  this.client
                     ...
                     .getHabboInfo()
                     .getCurrentRoom()
                     .sendComposer(new UpdateStackHeightComposer(tile.x, tile.y, tile.z, tile.relativeHeight()).compose());
               ...
               LOGGER.error(
                  "[Catalog] No definition in catalog_clothing found for clothing name " + item.getBaseItem().getName() + ". Could not redeem clothing!"
               );
            }
         }
      }
