...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/games/battlebanzai/scoreboards/InteractionBattleBanzaiScoreboard.class */
public class InteractionBattleBanzaiScoreboard extends InteractionGameScoreboard {
    public InteractionBattleBanzaiScoreboard(ResultSet resultSet, Item item, GameTeamColors gameTeamColors) throws SQLException {
        super(resultSet, item, gameTeamColors);
    }

    public InteractionBattleBanzaiScoreboard(int i, int i2, Item item, String str, int i3, int i4, GameTeamColors gameTeamColors) {
