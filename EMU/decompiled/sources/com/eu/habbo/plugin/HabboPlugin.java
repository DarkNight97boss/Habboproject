...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/plugin/HabboPlugin.class */
public abstract class HabboPlugin {
    ...
    public boolean isRegistered(Class<? extends Event> cls) {
        return this.registeredEvents.containsKey(cls);
    }

    public abstract boolean hasPermission(Habbo habbo, String str);
}
