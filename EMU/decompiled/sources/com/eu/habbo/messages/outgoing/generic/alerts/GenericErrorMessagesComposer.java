...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/outgoing/generic/alerts/GenericErrorMessagesComposer.class */
public class GenericErrorMessagesComposer extends MessageComposer {
    ...
    public GenericErrorMessagesComposer(int i) {
        this.errorCode = i;
    }
