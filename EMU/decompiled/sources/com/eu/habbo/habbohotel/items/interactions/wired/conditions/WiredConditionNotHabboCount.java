...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotHabboCount.class */
public class WiredConditionNotHabboCount extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotHabboCount$JsonData.class */
    ...
    public WiredConditionNotHabboCount(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.lowerLimit = 10;
        this.upperLimit = 20;
    }

    public WiredConditionNotHabboCount(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void loadWiredData(ResultSet resultSet, Room room) throws SQLException {
        ...
        if (string.startsWith("{")) {
            WiredConditionHabboCount.JsonData jsonData = (WiredConditionHabboCount.JsonData) WiredHandler.getGsonBuilder().create().fromJson(string, WiredConditionHabboCount.JsonData.class);
