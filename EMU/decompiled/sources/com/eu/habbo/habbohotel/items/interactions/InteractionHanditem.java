...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionHanditem.class */
public class InteractionHanditem extends InteractionDefault {
    public InteractionHanditem(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public InteractionHanditem(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    protected void handle(Room room, RoomUnit roomUnit) {
        ...
        if (getExtradata().equals("0")) {
            room.giveHandItem(roomUnit, getBaseItem().getRandomVendingItem());
