    ...
    return (
        <div className="p-3 flex flex-col gap-3 relative">
            ...
            <div className="bg-white rounded border border-[#b9b3a5] p-2 flex flex-col gap-2">
                <Text bold>{ LocalizeText('wired.tools.monitor.logs') }:</Text>
                    ...
                    <table className="w-full text-[12px]">
                        <thead className="bg-[#efede5] sticky top-0">
                            <tr>
                                ...
                                <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.amount') }</th>
                                <th className="text-left px-2 py-1">{ LocalizeText('wired.tools.monitor.column.latest_occurrence') }</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div className="flex justify-between gap-2">
                    <Button
                        ...
                        { LocalizeText('wired.tools.monitor.clear_all') }
                    </Button>
                    <Button
                        disabled={ !monitorHistoryRows.length }
                        variant="secondary"
                        onClick={ onOpenMonitorHistory }>
                        { LocalizeText('wired.tools.monitor.view_full_logs') }
                    </Button>
                </div>
            </div>
        </div>
