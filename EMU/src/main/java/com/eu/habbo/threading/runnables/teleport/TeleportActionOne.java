...
public class TeleportActionOne implements Runnable {
   ...
   public void run() {
      if (this.client.getHabbo().getHabboInfo().getCurrentRoom() == this.room) {
         ...
         if (this.client.getHabbo().getRoomUnit().getCurrentLocation()
            != this.room.getLayout().getTile(this.currentTeleport.getX(), this.currentTeleport.getY())) {
            ...
            this.client
               .getHabbo()
               .getRoomUnit()
               .setStatus(RoomUnitStatus.MOVE, this.currentTeleport.getX() + "," + this.currentTeleport.getY() + "," + this.currentTeleport.getZ());
