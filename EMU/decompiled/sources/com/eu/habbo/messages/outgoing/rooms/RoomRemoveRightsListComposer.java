...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/outgoing/rooms/RoomRemoveRightsListComposer.class */
public class RoomRemoveRightsListComposer extends MessageComposer {
    private final Room room;
    private final int userId;

    public RoomRemoveRightsListComposer(Room room, int i) {
        this.room = room;
        this.userId = i;
    }
