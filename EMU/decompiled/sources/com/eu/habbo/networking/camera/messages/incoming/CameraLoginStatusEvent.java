...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/networking/camera/messages/incoming/CameraLoginStatusEvent.class */
public class CameraLoginStatusEvent extends CameraIncomingMessage {
    ...
    public static final int OLD_BUILD = 5;
    public static final int NO_CAMERA_SUBSCRIPTION = 6;

    public CameraLoginStatusEvent(Short sh, ByteBuf byteBuf) {
        super(sh, byteBuf);
    }
