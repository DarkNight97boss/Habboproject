...
public class WiredEffectLeaveTeam extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectLeaveTeam.JsonData(this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectLeaveTeam.JsonData data = (WiredEffectLeaveTeam.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectLeaveTeam.JsonData.class);
