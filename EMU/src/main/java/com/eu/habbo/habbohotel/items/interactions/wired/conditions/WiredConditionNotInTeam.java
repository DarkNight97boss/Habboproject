...
public class WiredConditionNotInTeam extends InteractionWiredCondition {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      return habbo == null ? true : habbo.getHabboInfo().getGamePlayer() == null || !habbo.getHabboInfo().getGamePlayer().getTeamColor().equals(this.teamColor);
   }

   @Override
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionNotInTeam.JsonData(this.teamColor));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      try {
         ...
         if (wiredData.startsWith("{")) {
            WiredConditionNotInTeam.JsonData data = (WiredConditionNotInTeam.JsonData)WiredHandler.getGsonBuilder()
               .create()
               .fromJson(wiredData, WiredConditionNotInTeam.JsonData.class);
