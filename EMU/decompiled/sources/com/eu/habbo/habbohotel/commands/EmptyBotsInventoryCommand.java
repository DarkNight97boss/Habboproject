...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/commands/EmptyBotsInventoryCommand.class */
public class EmptyBotsInventoryCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] strArr) throws Exception {
        ...
        tIntObjectHashMap.putAll(habbo.getInventory().getBotsComponent().getBots());
        habbo.getInventory().getBotsComponent().getBots().clear();
        tIntObjectHashMap.forEachValue(bot -> {
