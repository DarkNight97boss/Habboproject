...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerHabboWalkOnFurni.class */
public class WiredTriggerHabboWalkOnFurni extends InteractionWiredTrigger {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerHabboWalkOnFurni$JsonData.class */
    ...
    public WiredTriggerHabboWalkOnFurni(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.items = new THashSet<>();
    }

    public WiredTriggerHabboWalkOnFurni(int i, int i2, Item item, String str, int i3, int i4) {
