...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/plugin/events/furniture/wired/WiredStackExecutedEvent.class */
public class WiredStackExecutedEvent extends RoomUnitEvent {
    ...
    public WiredStackExecutedEvent(Room room, RoomUnit roomUnit, InteractionWiredTrigger interactionWiredTrigger, THashSet<InteractionWiredEffect> tHashSet, THashSet<InteractionWiredCondition> tHashSet2) {
        super(room, roomUnit);
