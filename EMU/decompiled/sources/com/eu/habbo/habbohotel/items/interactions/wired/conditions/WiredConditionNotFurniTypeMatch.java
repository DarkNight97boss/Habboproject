...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotFurniTypeMatch.class */
public class WiredConditionNotFurniTypeMatch extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotFurniTypeMatch$JsonData.class */
    ...
    public WiredConditionNotFurniTypeMatch(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.items = new THashSet<>();
    }

    public WiredConditionNotFurniTypeMatch(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] objArr) {
        refresh();
        if (this.items.isEmpty() || objArr == null || objArr.length < 1 || !(objArr[0] instanceof HabboItem)) {
            return true;
        }
        HabboItem habboItem = (HabboItem) objArr[0];
        return this.items.stream().noneMatch(habboItem2 -> {
            return habboItem2 == habboItem;
        });
    }
    ...
    public void loadWiredData(ResultSet resultSet, Room room) throws SQLException {
        ...
        if (string.startsWith("{")) {
            Iterator<Integer> it = ((WiredConditionFurniTypeMatch.JsonData) WiredHandler.getGsonBuilder().create().fromJson(string, WiredConditionFurniTypeMatch.JsonData.class)).itemIds.iterator();
            while (it.hasNext()) {
        ...
        for (String str : resultSet.getString("wired_data").split(";")) {
