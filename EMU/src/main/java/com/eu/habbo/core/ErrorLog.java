...
public class ErrorLog implements DatabaseLoggable {
   ...
   public final String version = "Arcturus Morningstar 3.5.3 ";
   ...
   public ErrorLog(String type, Throwable e) {
      this.buildHash = "Arcturus Morningstar 3.5.3 ";
   ...
   public String getQuery() {
      return "INSERT INTO emulator_errors (timestamp, version, build_hash, type, stacktrace) VALUES (?, ?, ?, ?, ?)";
   }
