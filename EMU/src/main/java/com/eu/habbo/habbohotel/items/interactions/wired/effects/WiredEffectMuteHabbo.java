...
public class WiredEffectMuteHabbo extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectMuteHabbo.JsonData(this.getDelay(), this.length, this.message));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectMuteHabbo.JsonData data = (WiredEffectMuteHabbo.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectMuteHabbo.JsonData.class);
