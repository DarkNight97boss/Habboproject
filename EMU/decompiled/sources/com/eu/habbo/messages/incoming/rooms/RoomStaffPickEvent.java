...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/incoming/rooms/RoomStaffPickEvent.class */
    ...
    public void handle() throws Exception {
        if (this.client.getHabbo().hasPermission(Permission.ACC_STAFF_PICK)) {
            ...
            if (room != null) {
                ...
                NavigatorPublicCategory navigatorPublicCategory = (NavigatorPublicCategory) Emulator.getGameEnvironment().getNavigatorManager().publicCategories.get(Integer.valueOf(Emulator.getConfig().getInt("hotel.navigator.staffpicks.categoryid")));
                if (room.isStaffPromotedRoom()) {
                    ...
                    if (navigatorPublicCategory != null) {
                        navigatorPublicCategory.addRoom(room);
                    }
                } else if (navigatorPublicCategory != null) {
                    navigatorPublicCategory.removeRoom(room);
                }
