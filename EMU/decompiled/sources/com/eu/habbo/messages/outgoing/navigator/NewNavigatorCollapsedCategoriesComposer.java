...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/outgoing/navigator/NewNavigatorCollapsedCategoriesComposer.class */
public class NewNavigatorCollapsedCategoriesComposer extends MessageComposer {
    @Override // com.eu.habbo.messages.outgoing.MessageComposer
    protected ServerMessage composeInternal() {
        this.response.init(1543);
        this.response.appendInt((Integer) 46);
        ...
        this.response.appendString(NavigatorFavoriteFilter.name);
