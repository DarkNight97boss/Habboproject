...
public class WiredTriggerHabboWalkOnFurni extends InteractionWiredTrigger {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      return stuff.length >= 1 && stuff[0] instanceof HabboItem ? this.items.contains(stuff[0]) : false;
   }
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredTriggerHabboWalkOnFurni.JsonData(this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerHabboWalkOnFurni.JsonData data = (WiredTriggerHabboWalkOnFurni.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerHabboWalkOnFurni.JsonData.class);
