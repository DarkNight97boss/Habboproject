...
public class GuildDeleteEvent extends MessageHandler {
   ...
   public void handle() throws Exception {
      ...
      if (guild != null
         ...
         TObjectHashIterator var4 = members.iterator();

         while (var4.hasNext()) {
            GuildMember member = (GuildMember)var4.next();
         ...
         if (this.client.getHabbo().getHabboInfo().getCurrentRoom() != null
            && guild.getRoomId() == this.client.getHabbo().getHabboInfo().getCurrentRoom().getId()) {
