               ...
               if (this.client.getHabbo() == null) {
                  ...
                  if (habbo == null) {
                     ...
                     if (this.client.getHabbo().getHabboStats().nux
                        && (!Emulator.getConfig().getBoolean("retro.style.homeroom") || this.client.getHabbo().getHabboInfo().getHomeRoom() == 0)) {
                        if (!this.client.getHabbo().getHabboStats().nux
                     ...
                     messages.add(new UserClubComposer(this.client.getHabbo(), "HABBO_CLUB", UserClubComposer.RESPONSE_TYPE_LOGIN).compose());
                     ...
                     if (Emulator.getConfig().getBoolean("hotel.sanctions.enabled")) {
                        ...
                        if (modToolSanctionItems != null && modToolSanctionItems.size() > 0) {
                           ...
                           if (item.isMuted && item.muteDuration <= Emulator.getIntUnixTimestamp()) {
                              ...
                              Date muteDuration = new Date(item.muteDuration * 1000L);
                           ...
                           .run(
                              () -> {
                                 if (Emulator.getConfig().getBoolean("hotel.welcome.alert.oldstyle")) {
                                    this.client
                                       .sendResponse(
                                          new MessagesForYouComposer(
                                             HabboManager.WELCOME_MESSAGE
