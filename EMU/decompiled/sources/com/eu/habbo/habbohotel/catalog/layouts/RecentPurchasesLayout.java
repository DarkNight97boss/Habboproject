...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/RecentPurchasesLayout.class */
public class RecentPurchasesLayout extends CatalogPage {
    public RecentPurchasesLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("default_3x3");
