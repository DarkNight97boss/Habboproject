...
public class WiredEffectJoinTeam extends InteractionWiredEffect {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      if (habbo.getHabboInfo().getGamePlayer() != null
         ...
         && (
            habbo.getHabboInfo().getCurrentGame() != WiredGame.class
               || habbo.getHabboInfo().getCurrentGame() == WiredGame.class && habbo.getHabboInfo().getGamePlayer().getTeamColor() != this.teamColor
         )) {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectJoinTeam.JsonData(this.teamColor, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectJoinTeam.JsonData data = (WiredEffectJoinTeam.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectJoinTeam.JsonData.class);
