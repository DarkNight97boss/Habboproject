...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/LoyaltyVipBuyLayout.class */
public class LoyaltyVipBuyLayout extends CatalogPage {
    public LoyaltyVipBuyLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("loyalty_vip_buy");
