...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/outgoing/catalog/marketplace/MarketplaceItemPostedComposer.class */
public class MarketplaceItemPostedComposer extends MessageComposer {
    ...
    public MarketplaceItemPostedComposer(int i) {
        this.code = i;
    }
