...
<head>
	...
	<title>ZabboASE &bull; View COTW</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li>Management</li> <li class="active">View COTW</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">View COTW</h1>
			</div>
		</div><!--/.row-->
...
echo '
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Success!</strong> This users COTW submission entry was updated. Redirecting you back to the dashboard...
									</div>';
