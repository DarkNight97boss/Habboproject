...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/incoming/modtool/ReportThreadEvent.class */
public class ReportThreadEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (Emulator.getGameEnvironment().getModToolManager().getCfhTopic(iIntValue3) == null || (byId = ForumThread.getById(iIntValue2)) == null) {
            return;
        }
        ...
        modToolIssue.category = iIntValue3;
