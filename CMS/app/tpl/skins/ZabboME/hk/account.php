...
<head>
	...
	<title>ZabboASE &bull; Account</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li class="active">Account Settings</li>
			</ol>
		</div><!--/.row-->
...
?>
				...
				<tr>
					<td>Pin</td>
					<td><input class="form-control input-sm" type="text" name="clientpin" value="<?php
echo mysql_result(mysql_query("SELECT client_pin FROM users WHERE id = '" . $_SESSION['user']['id'] . "'"), 0);
?>" /></td>
				</tr>
				<tr>
					<td></td>
