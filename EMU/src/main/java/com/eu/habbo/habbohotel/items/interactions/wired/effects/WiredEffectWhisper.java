...
public class WiredEffectWhisper extends InteractionWiredEffect {
               ...
               h.getClient()
                  .sendResponse(
                     new RoomUserWhisperComposer(
                        new RoomChatMessage(
                           this.message
                              .replace("%user%", h.getHabboInfo().getUsername())
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectWhisper.JsonData(this.message, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectWhisper.JsonData data = (WiredEffectWhisper.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectWhisper.JsonData.class);
