...
public class WiredEffectGiveScoreToTeam extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectGiveScoreToTeam.JsonData(this.points, this.count, this.teamColor, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectGiveScoreToTeam.JsonData data = (WiredEffectGiveScoreToTeam.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectGiveScoreToTeam.JsonData.class);
