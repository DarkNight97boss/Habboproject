...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotHabboWearsBadge.class */
public class WiredConditionNotHabboWearsBadge extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionNotHabboWearsBadge$JsonData.class */
    ...
    public WiredConditionNotHabboWearsBadge(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.badge = Emulator.PREVIEW;
    }

    public WiredConditionNotHabboWearsBadge(int i, int i2, Item item, String str, int i3, int i4) {
