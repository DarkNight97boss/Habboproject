...
public class CrackableReward {
   ...
   public final Map<Integer, Entry<Integer, Integer>> prizes;
   ...
   public CrackableReward(ResultSet set) throws SQLException {
      ...
      if (!set.getString("prizes").isEmpty()) {
         this.totalChance = 0;
         ...
         for (String prize : prizes) {
            try {
               ...
               this.prizes.put(itemId, new SimpleEntry<>(this.totalChance, this.totalChance + chance));
   ...
   public int getRandomReward() {
      ...
      for (Entry<Integer, Entry<Integer, Integer>> set : this.prizes.entrySet()) {
         notFound = set.getKey();
