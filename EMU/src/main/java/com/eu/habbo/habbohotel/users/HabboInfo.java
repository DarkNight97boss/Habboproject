...
public class HabboInfo implements Runnable {
   ...
   private void loadCurrencies() {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("SELECT * FROM users_currency WHERE user_id = ?");
   ...
   private void loadSavedSearches() {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("SELECT * FROM users_saved_searches WHERE user_id = ?");
   ...
   public void addSavedSearch(NavigatorSavedSearch search) {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO users_saved_searches (search_code, filter, user_id) VALUES (?, ?, ?)", 1);
   ...
   public void deleteSavedSearch(NavigatorSavedSearch search) {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("DELETE FROM users_saved_searches WHERE id = ?");
   ...
   private void loadMessengerCategories() {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("SELECT * FROM messenger_categories WHERE user_id = ?");
   ...
   public void addMessengerCategory(MessengerCategory category) {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO messenger_categories (name, user_id) VALUES (?, ?)", 1);
   ...
   public void deleteMessengerCategory(MessengerCategory category) {
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement("DELETE FROM messenger_categories WHERE id = ?");
      ...
      try {
         ...
         try {
            PreparedStatement statement = connection.prepareStatement(
               "UPDATE users SET motto = ?, online = ?, look = ?, gender = ?, credits = ?, last_login = ?, last_online = ?, home_room = ?, ip_current = ?, `rank` = ?, machine_id = ?, username = ? WHERE id = ?"
            );
