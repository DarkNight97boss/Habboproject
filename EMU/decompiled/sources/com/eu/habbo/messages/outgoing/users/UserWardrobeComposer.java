...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/outgoing/users/UserWardrobeComposer.class */
public class UserWardrobeComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.appendInt(Integer.valueOf(this.wardrobeComponent.getLooks().size()));
        for (WardrobeComponent.WardrobeItem wardrobeItem : this.wardrobeComponent.getLooks().values()) {
            this.response.appendInt(Integer.valueOf(wardrobeItem.getSlotId()));
