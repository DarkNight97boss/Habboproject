...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/SpacesLayout.class */
public class SpacesLayout extends CatalogPage {
    public SpacesLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("spaces_new");
