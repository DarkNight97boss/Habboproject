         ...
         if (item != null) {
            ...
            if (pet instanceof HorsePet) {
               if (item.getBaseItem().getName().toLowerCase().startsWith("horse_dye")) {
                  ...
                  if (item.getBaseItem().getName().toLowerCase().startsWith("horse_hairstyle")) {
               ...
               if (item.getBaseItem().getName().equalsIgnoreCase("mnstr_revival")) {
                  if (((MonsterplantPet)pet).isDead()) {
                     ...
                     AchievementManager.progressAchievement(
                        this.client.getHabbo(), Emulator.getGameEnvironment().getAchievementManager().getAchievement("MonsterPlantHealer")
                     );
                  ...
                  && ((MonsterplantPet)pet).isFullyGrown()
                  && !((MonsterplantPet)pet).canBreed()
                  && (
                     item.getBaseItem().getName().equalsIgnoreCase("mnstr_rebreed") && ((MonsterplantPet)pet).getRarity() <= 5
                        || item.getBaseItem().getName().equalsIgnoreCase("mnstr_rebreed_2")
                           && ((MonsterplantPet)pet).getRarity() >= 6
                           && ((MonsterplantPet)pet).getRarity() <= 8
