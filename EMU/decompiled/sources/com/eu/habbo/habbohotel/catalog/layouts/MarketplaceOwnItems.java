...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/MarketplaceOwnItems.class */
public class MarketplaceOwnItems extends CatalogPage {
    public MarketplaceOwnItems(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("marketplace_own_items");
