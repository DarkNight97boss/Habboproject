...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/pets/actions/ActionPlayDead.class */
public class ActionPlayDead extends PetAction {
    ...
    public boolean apply(Pet pet, Habbo habbo, String[] strArr) {
        pet.clearPosture();
        pet.getRoomUnit().setStatus(RoomUnitStatus.DEAD, pet.getRoom().getStackHeight(pet.getRoomUnit().getX(), pet.getRoomUnit().getY(), false) + Emulator.PREVIEW);
