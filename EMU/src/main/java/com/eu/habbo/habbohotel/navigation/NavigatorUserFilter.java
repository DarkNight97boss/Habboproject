   ...
   public List<SearchResultList> getResult(Habbo habbo) {
      ...
      resultLists.add(
         new SearchResultList(
            ...
            "",
            SearchAction.NONE,
            habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("my"),
            habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("my"),
            rooms,
            true,
            true,
      ...
      if (!favoriteRooms.isEmpty()) {
         resultLists.add(
            new SearchResultList(
               ...
               "",
               SearchAction.NONE,
               habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("favorites"),
               habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("favorites"),
               favoriteRooms,
               true,
               true,
               DisplayOrder.ORDER_NUM,
      ...
      if (!frequentlyVisited.isEmpty()) {
         resultLists.add(
            new SearchResultList(
               ...
               "",
               SearchAction.NONE,
               habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("history_freq"),
               habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("history_freq"),
               frequentlyVisited,
               true,
               true,
               DisplayOrder.ORDER_NUM,
      ...
      if (!groupRooms.isEmpty()) {
         resultLists.add(
            new SearchResultList(
               ...
               "",
               SearchAction.NONE,
               habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("my_groups"),
               habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("my_groups"),
               groupRooms,
               true,
               true,
               DisplayOrder.ORDER_NUM,
      ...
      if (!friendRooms.isEmpty()) {
         resultLists.add(
            new SearchResultList(
               ...
               "",
               SearchAction.NONE,
               habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("with_friends"),
               habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("with_friends"),
               friendRooms,
               true,
               true,
               DisplayOrder.ORDER_NUM,
      ...
      if (!rightRooms.isEmpty()) {
         resultLists.add(
            new SearchResultList(
               ...
               "",
               SearchAction.NONE,
               habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("with_rights"),
               habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("with_rights"),
               rightRooms,
               true,
               true,
               DisplayOrder.ORDER_NUM,
