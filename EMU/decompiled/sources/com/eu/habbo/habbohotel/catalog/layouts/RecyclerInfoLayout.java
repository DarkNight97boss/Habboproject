...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/RecyclerInfoLayout.class */
public class RecyclerInfoLayout extends CatalogPage {
    public RecyclerInfoLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("recycler_info");
