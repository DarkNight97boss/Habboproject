...
public class WiredEffectBotGiveHandItem extends InteractionWiredEffect {
         ...
         tasks.add(
            () -> {
               if (roomUnit.getRoom() != null
                  ...
                  && roomUnit.getCurrentLocation().distance(bot.getRoomUnit().getCurrentLocation()) < 2.0) {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotGiveHandItem.JsonData(this.botName, this.itemId, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotGiveHandItem.JsonData data = (WiredEffectBotGiveHandItem.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotGiveHandItem.JsonData.class);
