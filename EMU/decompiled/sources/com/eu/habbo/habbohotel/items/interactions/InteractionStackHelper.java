...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionStackHelper.class */
public class InteractionStackHelper extends HabboItem {
    public InteractionStackHelper(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public InteractionStackHelper(int i, int i2, Item item, String str, int i3, int i4) {
