...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerAtTimeLong.class */
public class WiredTriggerAtTimeLong extends InteractionWiredTrigger implements WiredTriggerReset {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/triggers/WiredTriggerAtTimeLong$JsonData.class */
    ...
    public WiredTriggerAtTimeLong(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public WiredTriggerAtTimeLong(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        room.getRoomSpecialTypes().getEffects(getX(), getY()).forEach(new TObjectProcedure<InteractionWiredEffect>() { // from class: com.eu.habbo.habbohotel.items.interactions.wired.triggers.WiredTriggerAtTimeLong.1
