...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionPoster.class */
public class InteractionPoster extends HabboItem {
    public InteractionPoster(int i, int i2, Item item, String str, int i3, int i4) {
        super(i, i2, item, str, i3, i4);
    }

    public InteractionPoster(ResultSet resultSet, Item item) throws SQLException {
