...
public class WiredEffectGiveReward extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(
            new WiredEffectGiveReward.JsonData(this.limit, this.given, this.rewardTime, this.uniqueRewards, this.limitationInterval, rewards, this.getDelay())
         );
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectGiveReward.JsonData data = (WiredEffectGiveReward.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectGiveReward.JsonData.class);
         ...
         if (data.length > 0) {
            ...
            if (data.length > 6 && !data[6].equalsIgnoreCase("\t")) {
   ...
   public void serializeWiredData(ServerMessage message, Room room) {
      ...
      TObjectHashIterator invalidTriggers = this.rewardItems.iterator();

      while (invalidTriggers.hasNext()) {
         WiredGiveRewardItem item = (WiredGiveRewardItem)invalidTriggers.next();
