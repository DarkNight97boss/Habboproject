...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/permissions/Permission.class */
public class Permission {
    ...
    public Permission(String str, PermissionSetting permissionSetting) {
        this.key = str;
        this.setting = permissionSetting;
    }
}
