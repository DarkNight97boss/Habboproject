            ...
            if (name.equals(this.client.getHabbo().getHabboStats().changeNameChecked)) {
               ...
               if (habboInfo == null) {
                  ...
                  this.client
                     .getHabbo()
                     .getMessenger()
                     .connectionChanged(this.client.getHabbo(), true, this.client.getHabbo().getHabboInfo().getCurrentRoom() != null);
                  ...
                  try {
                     ...
                     try {
                        PreparedStatement statement = connection.prepareStatement(
                           "INSERT INTO namechange_log (user_id, old_name, new_name, timestamp) VALUES (?, ?, ?, ?) "
                        );
                  ...
                  this.client.sendResponse(new ChangeNameCheckResultComposer(5, name, new ArrayList<>()));
               }
            }
         }
      }
