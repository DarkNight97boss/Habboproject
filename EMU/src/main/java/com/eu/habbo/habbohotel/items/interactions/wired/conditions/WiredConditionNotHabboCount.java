...
public class WiredConditionNotHabboCount extends InteractionWiredCondition {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredConditionNotHabboCount.JsonData(this.lowerLimit, this.upperLimit));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionHabboCount.JsonData data = (WiredConditionHabboCount.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionHabboCount.JsonData.class);
