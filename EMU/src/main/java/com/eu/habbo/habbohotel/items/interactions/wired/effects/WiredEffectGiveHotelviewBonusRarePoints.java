...
public class WiredEffectGiveHotelviewBonusRarePoints extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectGiveHotelviewBonusRarePoints.JsonData(this.getDelay(), this.amount));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectGiveHotelviewBonusRarePoints.JsonData data = (WiredEffectGiveHotelviewBonusRarePoints.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectGiveHotelviewBonusRarePoints.JsonData.class);
         this.setDelay(data.delay);
         this.amount = data.amount;
      } else if (wiredData.split("\t").length >= 2) {
