...
public class WiredConditionNotFurniHaveFurni extends InteractionWiredCondition {
               ...
               .allMatch(
                  item -> {
                     ...
                     return occupiedTiles.stream()
                        .noneMatch(tile -> room.getItemsAt(tile).stream().anyMatch(matchedItem -> matchedItem != item && matchedItem.getZ() >= minZ));
                  }
               )
            : this.items
               .stream()
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredConditionNotFurniHaveFurni.JsonData(this.all, this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionNotFurniHaveFurni.JsonData data = (WiredConditionNotFurniHaveFurni.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionNotFurniHaveFurni.JsonData.class);
         this.all = data.all;
