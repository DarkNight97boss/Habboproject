...
public class WiredEffectMoveRotateFurni extends InteractionWiredEffect implements ICycleable {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      this.items.removeIf(itemx -> Emulator.getGameEnvironment().getRoomManager().getRoom(this.getRoomId()).getHabboItem(itemx.getId()) == null);
      ...
      while (var4.hasNext()) {
         ...
         if (!this.itemCooldowns.contains(item)) {
            ...
            if (newLocation != null
               ...
               && room.furnitureFitsAt(newLocation, item, newRotation, false) == FurnitureMovementError.NONE
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(
            new WiredEffectMoveRotateFurni.JsonData(
               this.direction, this.rotation, this.getDelay(), this.items.stream().map(HabboItem::getId).collect(Collectors.toList())
            )
         );
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectMoveRotateFurni.JsonData data = (WiredEffectMoveRotateFurni.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectMoveRotateFurni.JsonData.class);
