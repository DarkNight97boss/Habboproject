...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionRoomOMatic.class */
public class InteractionRoomOMatic extends InteractionDefault {
    public InteractionRoomOMatic(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public InteractionRoomOMatic(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public void onClick(GameClient gameClient, Room room, Object[] objArr) throws Exception {
        if (gameClient != null) {
            gameClient.sendResponse(new OpenRoomCreationWindowComposer());
        }
    }
}
