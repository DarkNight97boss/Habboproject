...
public class ReportPhotoEvent extends MessageHandler {
   ...
   public void handle() throws Exception {
      ...
      if (hasExtradataId) {
         String roomId = this.packet.readString();
      }
      ...
      if (topic != null) {
         ...
         if (room != null) {
            ...
            if (item != null && item instanceof InteractionExternalImage) {
               ...
               if (photoOwner != null) {
                  ...
                  this.client.sendResponse(new ModToolReportReceivedAlertComposer(0, ""));
