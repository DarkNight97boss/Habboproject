...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/messages/incoming/modtool/ModToolWarnEvent.class */
public class ModToolWarnEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (habbo != null) {
            Emulator.getGameEnvironment().getModToolManager().alert(this.client.getHabbo(), habbo, this.packet.readString(), SupportUserAlertedReason.CAUTION);
        }
    }
}
