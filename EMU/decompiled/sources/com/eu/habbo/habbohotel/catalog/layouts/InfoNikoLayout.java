...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/InfoNikoLayout.class */
public class InfoNikoLayout extends CatalogPage {
    public InfoNikoLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
