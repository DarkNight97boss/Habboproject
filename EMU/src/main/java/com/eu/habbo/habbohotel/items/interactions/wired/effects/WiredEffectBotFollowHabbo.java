...
public class WiredEffectBotFollowHabbo extends InteractionWiredEffect {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredEffectBotFollowHabbo.JsonData(this.botName, this.mode, this.getDelay()));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredEffectBotFollowHabbo.JsonData data = (WiredEffectBotFollowHabbo.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredEffectBotFollowHabbo.JsonData.class);
