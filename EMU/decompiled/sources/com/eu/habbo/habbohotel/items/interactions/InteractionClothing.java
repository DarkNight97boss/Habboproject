...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/InteractionClothing.class */
public class InteractionClothing extends HabboItem {
    public InteractionClothing(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public InteractionClothing(int i, int i2, Item item, String str, int i3, int i4) {
