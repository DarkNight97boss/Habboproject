...
public class QuestCompletedComposer extends MessageComposer {
   private final QuestCompletedComposer.UnknownClass unknownClass;
   private final boolean unknowbOolean;

   public QuestCompletedComposer(QuestCompletedComposer.UnknownClass unknownClass, boolean unknowbOolean) {
