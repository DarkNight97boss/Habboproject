...
class HopperActionThree implements Runnable {
   ...
   public void run() {
      ...
      HabboItem targetTeleport = targetRoom.getHabboItem(this.targetItemId);
      if (targetTeleport == null) {
         ...
         if (targetTeleport instanceof InteractionCostumeHopper) {
            AchievementManager.progressAchievement(
               this.client.getHabbo(), Emulator.getGameEnvironment().getAchievementManager().getAchievement("CostumeHopper")
            );
         }
      }
   }
