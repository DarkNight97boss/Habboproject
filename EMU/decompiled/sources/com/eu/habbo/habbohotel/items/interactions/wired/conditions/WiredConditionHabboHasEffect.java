...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionHabboHasEffect.class */
public class WiredConditionHabboHasEffect extends InteractionWiredCondition {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/conditions/WiredConditionHabboHasEffect$JsonData.class */
    ...
    public WiredConditionHabboHasEffect(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
        this.effectId = 0;
    }

    public WiredConditionHabboHasEffect(int i, int i2, Item item, String str, int i3, int i4) {
