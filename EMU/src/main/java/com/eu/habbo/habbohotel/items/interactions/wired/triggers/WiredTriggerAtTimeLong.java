...
public class WiredTriggerAtTimeLong extends InteractionWiredTrigger implements WiredTriggerReset {
   ...
   public String getWiredData() {
      return WiredHandler.getGsonBuilder().create().toJson(new WiredTriggerAtTimeLong.JsonData(this.executeTime));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredTriggerAtTimeLong.JsonData data = (WiredTriggerAtTimeLong.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredTriggerAtTimeLong.JsonData.class);
