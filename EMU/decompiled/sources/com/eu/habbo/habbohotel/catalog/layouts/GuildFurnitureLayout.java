...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/catalog/layouts/GuildFurnitureLayout.class */
public class GuildFurnitureLayout extends CatalogPage {
    public GuildFurnitureLayout(ResultSet resultSet) throws SQLException {
        super(resultSet);
    }
    ...
    public void serialize(ServerMessage serverMessage) {
        serverMessage.appendString("guild_custom_furni");
