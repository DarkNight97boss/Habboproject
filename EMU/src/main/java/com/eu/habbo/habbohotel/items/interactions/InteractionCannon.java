...
public class InteractionCannon extends HabboItem {
   ...
   public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
      ...
      if (room != null) {
         ...
         if ((client == null || tiles.contains(client.getHabbo().getRoomUnit().getCurrentLocation()) && client.getHabbo().getRoomUnit().canWalk())
            && !this.cooldown) {
            if (client != null) {
            ...
            Emulator.getThreading().run(new CannonKickAction(this, room, client), 750L);
