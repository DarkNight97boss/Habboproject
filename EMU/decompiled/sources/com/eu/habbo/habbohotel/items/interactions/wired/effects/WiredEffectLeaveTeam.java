...
/* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectLeaveTeam.class */
public class WiredEffectLeaveTeam extends InteractionWiredEffect {
    ...
    /* JADX INFO: loaded from: Habbo-3.5.3.jar:com/eu/habbo/habbohotel/items/interactions/wired/effects/WiredEffectLeaveTeam$JsonData.class */
    ...
    public WiredEffectLeaveTeam(ResultSet resultSet, Item item) throws SQLException {
        super(resultSet, item);
    }

    public WiredEffectLeaveTeam(int i, int i2, Item item, String str, int i3, int i4) {
    ...
    public String getWiredData() {
        return WiredHandler.getGsonBuilder().create().toJson(new JsonData(getDelay()));
    }
    ...
    public void loadWiredData(ResultSet resultSet, Room room) throws SQLException {
        ...
        if (string.startsWith("{")) {
            setDelay(((JsonData) WiredHandler.getGsonBuilder().create().fromJson(string, JsonData.class)).delay);
        } else {
            setDelay(Integer.valueOf(string).intValue());
        }
    }
    ...
    public void serializeWiredData(ServerMessage serverMessage, Room room) {
        ...
        room.getRoomSpecialTypes().getTriggers(getX(), getY()).forEach(new TObjectProcedure<InteractionWiredTrigger>() { // from class: com.eu.habbo.habbohotel.items.interactions.wired.effects.WiredEffectLeaveTeam.1
