...
public class SearchUserEvent extends MessageHandler {
   ...
   public void handle() throws Exception {
      if (System.currentTimeMillis() - this.client.getHabbo().getHabboStats().lastUsersSearched >= 3000L) {
         ...
         if (!username.isEmpty()) {
            ...
            if (this.client.getHabbo().getMessenger() != null) {
               ...
               this.client
                  .sendResponse(new UserSearchResultComposer(buddies, this.client.getHabbo().getMessenger().getFriends(username), this.client.getHabbo()));
            }
         }
      }
   }
