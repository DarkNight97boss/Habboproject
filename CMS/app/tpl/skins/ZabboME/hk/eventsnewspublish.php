	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>Dashboard</li> <li>Moderation</li> <li class="active">Write Event News Article</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Write Event News Article</h1>
			</div>
		</div><!--/.row-->
...
echo '<div class="alert alert-success"><strong>Well done!</strong> Event News Article created.</div>';
header("refresh:0;url=/ase/index.php?url=eventsnews");
}
...
?>
										...
										<div class="control-group">	
											<div class="controls">	
												<button type="submit" class="btn btn-primary btn-sm" style="float: right;background: #217332;margin-top: 2px;margin-left: 5px;height: 40px;font-variant-caps: all-small-caps;font-size: 15px;font-family: sans-serif;font-weight: bolder;border-radius: 3px;border-color: #0cde39;" name="news_create">Create Event Article</button>
											</div>
										</div>
									</form>
									<?php
