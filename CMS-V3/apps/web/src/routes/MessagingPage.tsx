...
/**
 * Pagina /messaging — replica DOM ufficiale habbo.it/messaging.
 *
 * Struttura ispezionata live (Chrome extension):
 *   <div class="content">
 *     <habbo-header-small>
 *       <header.header__wrapper.wrapper>
 *         <a.header__habbo__logo><h1.header__habbo__name>Habbo</h1></a>
 *         <habbo-user-menu>…</habbo-user-menu>
 *       </header>
 *       <habbo-navigation><nav.navigation>… + .navigation__item--hotel GIOCA</nav></habbo-navigation>
 *     </habbo-header-small>
 *     <habbo-tabs>
 *       <nav.tabs>
 *         <div.tabs__toggle><div.tabs__toggle__title>Messaggi</div></div>
 *         <ul.tabs__menu.ng-hide>
 *           <habbo-tab><li.tab><a.tab__link>Novità</a></li></habbo-tab>
 *           <habbo-tab><li.tab><a.tab__link.tab__link--active>Messaggi</a></li></habbo-tab>
 *         </ul.tabs__menu>
 *       </nav.tabs>
 *     </habbo-tabs>
 ...
 *         <h1>Messaggi</h1>
 *         <habbo-discussions>
 *           <habbo-empty-results>      ← ::after = sprite Frank
 *             <span>Non ci sono nuovi messaggi privati al momento</span>
 *           </habbo-empty-results>
 *         </habbo-discussions>
 *       </section>
 *     </main>
 ...
 *
 * Pagina solo per utenti autenticati: se !user redirige a /.
 */
    ...
    return (
        <>
            <div className="content">
                <HeaderSmallAuthed user={user} />
                <TabsAuthed activeTab="messaggi" />
                <main className="wrapper wrapper--content">
                    <habbo-moderation-notification />
                    <section>
                        <h1>Messaggi</h1>
                        <habbo-discussions>
                            <habbo-empty-results>
...
// ============================================================
// CHROME AUTHED (replica esatta di HomePage.tsx — solo questi
...
function TabsAuthed({ activeTab }: { activeTab: 'novita' | 'messaggi' }): ReactNode
{
    const noviActive = activeTab === 'novita';
    const msgActive = activeTab === 'messaggi';
    return (
        <habbo-tabs>
            <nav className="tabs">
                ...
                <ul className="tabs__menu ng-hide">
                    <habbo-tab>
                        <li className="tab">
                            <a href="/" className={`tab__link${noviActive ? ' tab__link--active' : ''}`}>Novità</a>
                        </li>
                    </habbo-tab>
                    <habbo-tab>
                        <li className="tab">
