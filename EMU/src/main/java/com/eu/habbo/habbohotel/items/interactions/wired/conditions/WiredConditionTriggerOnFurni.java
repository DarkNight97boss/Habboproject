...
public class WiredConditionTriggerOnFurni extends InteractionWiredCondition {
   ...
   public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
      ...
      this.refresh();
      return this.items.isEmpty() ? false : this.triggerOnFurni(roomUnit, room);
   }
   ...
   public String getWiredData() {
      ...
      return WiredHandler.getGsonBuilder()
         .create()
         .toJson(new WiredConditionTriggerOnFurni.JsonData(this.items.stream().map(HabboItem::getId).collect(Collectors.toList())));
   }
   ...
   public void loadWiredData(ResultSet set, Room room) throws SQLException {
      ...
      if (wiredData.startsWith("{")) {
         WiredConditionTriggerOnFurni.JsonData data = (WiredConditionTriggerOnFurni.JsonData)WiredHandler.getGsonBuilder()
            .create()
            .fromJson(wiredData, WiredConditionTriggerOnFurni.JsonData.class);
