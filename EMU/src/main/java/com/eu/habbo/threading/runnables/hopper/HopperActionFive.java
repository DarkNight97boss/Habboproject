...
class HopperActionFive implements Runnable {
   ...
   public void run() {
      ...
      RoomTile tile = this.room
         .getLayout()
         .getTileInFront(this.room.getLayout().getTile(this.currentTeleport.getX(), this.currentTeleport.getY()), this.currentTeleport.getRotation());
      if (tile != null) {
